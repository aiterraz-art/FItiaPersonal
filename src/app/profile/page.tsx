            ...
            <div className="space-y-6">
                ...
                <div className="glass-card p-6 border-gold/20 bg-gold/5">
                    ...
                    <div className="flex justify-between items-end">
                        <div>
                            <p className="text-zinc-400 text-xs font-medium mb-1">Calorías Objetivo</p>
                            <input
                                type="number"
                                value={profile.meta_kcal}
                                onChange={(e) => setProfile({ ...profile, meta_kcal: parseInt(e.target.value) })}
                                className="bg-transparent text-3xl font-bold focus:outline-none text-gold"
                            />
                        </div>
